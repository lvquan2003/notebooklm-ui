  ...
  return (
    <div className="h-full flex flex-col overflow-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <h3 className="text-lg font-medium mb-2">Các nguồn đã lưu sẽ xuất hiện ở đây</h3>
        <p className="text-sm text-gray-500 mb-6 max-w-xs">
          Nhấp vào Thêm nguồn ở trên để thêm tệp PDF, trang web, văn bản, video hoặc tệp âm thanh. Hoặc nhập một tệp
          ngay trên Google Drive.
        </p>

        <Button variant="outline" className="gap-2 rounded-full" onClick={() => setShowAddSourceDialog(true)}>
      ...
      <Dialog open={showAddSourceDialog} onOpenChange={setShowAddSourceDialog}>
        <DialogContent className="sm:max-w-[1000px] p-0 gap-0">
          <DialogHeader className="p-6 pb-2">
            ...
            <DialogTitle className="text-xl font-medium">Thêm nguồn</DialogTitle>
          ...
          <div className="px-6 py-2">
            <p className="text-sm text-gray-700 mb-4">
              Các nguồn giúp NotebookLM đưa ra câu trả lời dựa trên những thông tin quan trọng nhất đối với bạn.
              <br />
              (Ví dụ: kế hoạch tiếp thị, nội dung khóa học, ghi chú nghiên cứu, bản chép lời cuộc họp, tài liệu bán
              hàng, v.v.)
            </p>
            ...
            <div className="border border-dashed border-gray-300 rounded-lg p-8 mb-6">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-gray-500 mb-2">
                  Kéo và thả hoặc <span className="text-blue-500">chọn tệp</span> để tải lên
                </p>
              ...
              <Card className="border rounded-lg overflow-hidden">
                <CardContent className="p-4">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <Button variant="outline" className="w-full text-sm h-8 mt-2">
                      Google Tài liệu
                    </Button>
                  </div>
                </CardContent>
